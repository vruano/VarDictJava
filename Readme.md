...
The intent of this fork is *not* to add new functionalty but just to do some basic maintenance of otherwise no longer supported valuable piece of software. This encompasses fixing security vulnerabilities and perhaps fix some "show stopper" bugs as these araise. 
